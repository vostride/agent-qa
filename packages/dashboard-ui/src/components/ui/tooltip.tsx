...
function TooltipContent({
  ...
  return (
    <TooltipPrimitive.Portal>
      ...
      >
        {children}
        <TooltipPrimitive.Arrow className="z-50 size-2.5 translate-y-[calc(-50%_-_1px)] rotate-45 rounded-[2px] border border-border bg-popover fill-popover [clip-path:polygon(100%_0,100%_100%,0_100%)]" />
      </TooltipPrimitive.Content>
    </TooltipPrimitive.Portal>
  )
}
